...
from mpi_mamba.utils.base_model import BaseModel
from torch.nn import functional as F
from functools import partial
import numpy as np
from mpi_mamba.utils.beta_schedule import make_beta_schedule, default
from ldm.ddpm import DDPM


@MODEL_REGISTRY.register()
class MPI_Mamba_S2(BaseModel):
    """HI-Diff model for test."""

    def __init__(self, opt):
        super(MPI_Mamba_S2, self).__init__(opt)
    ...
    def optimize_parameters(self, current_iter, noise=None):
        ...
        # TODO baohan z shi daizaosheng de  
